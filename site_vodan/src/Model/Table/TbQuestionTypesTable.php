...
/**
 * TbQuestionTypes Model
 *
 * @method \App\Model\Entity\TbQuestionType get($primaryKey, $options = [])
 * @method \App\Model\Entity\TbQuestionType newEntity($data = null, array $options = [])
 ...
 * @method \App\Model\Entity\TbQuestionType[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\TbQuestionType findOrCreate($search, callable $callback = null, $options = [])
 */
class TbQuestionTypesTable extends Table
{
    /**
     * Initialize method
     *
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('tb_question_types');
        $this->setDisplayField('question_type_id');
        $this->setPrimaryKey('question_type_id');
    }
    ...
    public function validationDefault(Validator $validator)
    {
        $validator
            ...
            ->allowEmptyString('question_type_id', null, 'create');
