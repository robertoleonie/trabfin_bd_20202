...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $tbQuestionGroupsFormsRecord->questionGroupFormRecordID],
                ['confirm' => __('Are you sure you want to delete # {0}?', $tbQuestionGroupsFormsRecord->questionGroupFormRecordID)]
            )
        ?></li>
...
<div class="tbQuestionGroupsFormsRecords form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Tb Question Groups Forms Record') ?></legend>
        <?php
