...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(__('Delete Question Type'), ['action' => 'delete', $questionType->question_type_id], ['confirm' => __('Are you sure you want to delete # {0}?', $questionType->question_type_id)]) ?> </li>
...
<div class="questionTypes view large-9 medium-8 columns content">
    <h3><?= h($questionType->question_type_id) ?></h3>
