...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $questionGroupsForm->crfform_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $questionGroupsForm->crfform_id)]
            )
        ?></li>
...
<div class="questionGroupsForms form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Question Groups Form') ?></legend>
        <?php
