...
/**
 * TbQuestionGroupsFixture
 */
class TbQuestionGroupsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        'question_group_id' => ['type' => 'integer', 'length' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'autoIncrement' => true, 'precision' => null],
...
(en) description.', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['question_group_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
